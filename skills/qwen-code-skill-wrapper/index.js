/**
 * Qwen Code Skill (qwen-code-skill-wrapper)
 * 
 * SkillHub Standard Skill Format
 * 
 * @package @skillhub/qwen-code-skill-wrapper
 * @version 1.0.0
 * @author SkillHub
 * @license MIT
 * @see https://skillhub.com/skills/qwen-code-skill-wrapper
 */

// Skill 配置
const skillConfig = {
  name: 'qwen-code-skill-wrapper',
  displayName: 'Qwen Code Skill',
  version: '1.0.0',
  category: 'skillhub',
  format: 'skillhub-standard',
  author: 'SkillHub',
  license: 'MIT',
  homepage: 'https://skillhub.com/skills/qwen-code-skill-wrapper',
