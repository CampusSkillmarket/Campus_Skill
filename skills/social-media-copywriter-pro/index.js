 ...
 * 
 * @package @skillhub/social-media-copywriter-pro
 * @version 1.0.0
 * @author SkillHub
 * @license MIT
 * @see https://skillhub.com/skills/social-media-copywriter-pro
 */

// Skill 配置
const skillConfig = {
  name: 'social-media-copywriter-pro',
  displayName: '📱 社交媒体爆款文案',
  version: '1.0.0',
  category: 'skillhub',
  format: 'skillhub-standard',
  author: 'SkillHub',
  license: 'MIT',
  homepage: 'https://skillhub.com/skills/social-media-copywriter-pro',
