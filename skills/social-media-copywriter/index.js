 ...
 * 
 * @package @skillhub/social-media-copywriter
 * @version 1.0.0
 * @author SkillHub
 * @license MIT
 * @see https://skillhub.com/skills/social-media-copywriter
 */

// Skill 配置
const skillConfig = {
  name: 'social-media-copywriter',
  displayName: '社交媒体文案创作专家',
  version: '1.0.0',
  category: 'skillhub',
  format: 'skillhub-standard',
  author: 'SkillHub',
  license: 'MIT',
  homepage: 'https://skillhub.com/skills/social-media-copywriter',
