 ...
 * 
 * @package @skillhub/personal-branding
 * @version 1.0.0
 * @author SkillHub
 * @license MIT
 * @see https://skillhub.com/skills/personal-branding
 */

// Skill 配置
const skillConfig = {
  name: 'personal-branding',
  displayName: '👤 个人品牌搭建助手',
  version: '1.0.0',
  category: 'skillhub',
  format: 'skillhub-standard',
  author: 'SkillHub',
  license: 'MIT',
  homepage: 'https://skillhub.com/skills/personal-branding',
