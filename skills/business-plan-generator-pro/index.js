/**
 * 💼 商业计划书生成器 (business-plan-generator-pro)
 * 
 * SkillHub Standard Skill Format
 * 
 * @package @skillhub/business-plan-generator-pro
 * @version 1.0.0
 * @author SkillHub
 * @license MIT
 * @see https://skillhub.com/skills/business-plan-generator-pro
 */

// Skill 配置
const skillConfig = {
  name: 'business-plan-generator-pro',
  displayName: '💼 商业计划书生成器',
  version: '1.0.0',
  category: 'skillhub',
  format: 'skillhub-standard',
  author: 'SkillHub',
  license: 'MIT',
  homepage: 'https://skillhub.com/skills/business-plan-generator-pro',
