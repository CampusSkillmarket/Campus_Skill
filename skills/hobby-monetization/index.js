 ...
 * 
 * @package @skillhub/hobby-monetization
 * @version 1.0.0
 * @author SkillHub
 * @license MIT
 * @see https://skillhub.com/skills/hobby-monetization
 */

// Skill 配置
const skillConfig = {
  name: 'hobby-monetization',
  displayName: '🎨 兴趣技能变现助手',
  version: '1.0.0',
  category: 'skillhub',
  format: 'skillhub-standard',
  author: 'SkillHub',
  license: 'MIT',
  homepage: 'https://skillhub.com/skills/hobby-monetization',
