/**
 * 💼 岗位信息获取与匹配助手 (job-search)
 * 
 * SkillHub Standard Skill Format
 * 
 * @package @skillhub/job-search
 * @version 1.0.0
 * @author SkillHub
 * @license MIT
 * @see https://skillhub.com/skills/job-search
 */

// Skill 配置
const skillConfig = {
  name: 'job-search',
  displayName: '💼 岗位信息获取与匹配助手',
  version: '1.0.0',
  category: 'skillhub',
  format: 'skillhub-standard',
  author: 'SkillHub',
  license: 'MIT',
  homepage: 'https://skillhub.com/skills/job-search',
