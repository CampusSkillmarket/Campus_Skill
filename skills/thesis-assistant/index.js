 ...
 * 
 * @package @skillhub/thesis-assistant
 * @version 1.0.0
 * @author SkillHub
 * @license MIT
 * @see https://skillhub.com/skills/thesis-assistant
 */

// Skill 配置
const skillConfig = {
  name: 'thesis-assistant',
  displayName: '🎓 毕业论文/设计助手',
  version: '1.0.0',
  category: 'skillhub',
  format: 'skillhub-standard',
  author: 'SkillHub',
  license: 'MIT',
  homepage: 'https://skillhub.com/skills/thesis-assistant',
