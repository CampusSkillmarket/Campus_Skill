 ...
 * 
 * @package @skillhub/social-relationships
 * @version 1.0.0
 * @author SkillHub
 * @license MIT
 * @see https://skillhub.com/skills/social-relationships
 */

// Skill 配置
const skillConfig = {
  name: 'social-relationships',
  displayName: '🤝 人际关系与社交助手',
  version: '1.0.0',
  category: 'skillhub',
  format: 'skillhub-standard',
  author: 'SkillHub',
  license: 'MIT',
  homepage: 'https://skillhub.com/skills/social-relationships',
