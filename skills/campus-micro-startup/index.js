 ...
 * 
 * @package @skillhub/campus-micro-startup
 * @version 1.0.0
 * @author SkillHub
 * @license MIT
 * @see https://skillhub.com/skills/campus-micro-startup
 */

// Skill 配置
const skillConfig = {
  name: 'campus-micro-startup',
  displayName: '🏫 校内微创业探索助手',
  version: '1.0.0',
  category: 'skillhub',
  format: 'skillhub-standard',
  author: 'SkillHub',
  license: 'MIT',
  homepage: 'https://skillhub.com/skills/campus-micro-startup',
