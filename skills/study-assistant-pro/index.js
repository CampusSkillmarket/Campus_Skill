 ...
 * 
 * @package @skillhub/study-assistant-pro
 * @version 1.0.0
 * @author SkillHub
 * @license MIT
 * @see https://skillhub.com/skills/study-assistant-pro
 */

// Skill 配置
const skillConfig = {
  name: 'study-assistant-pro',
  displayName: '📚 学业助手 Pro',
  version: '1.0.0',
  category: 'skillhub',
  format: 'skillhub-standard',
  author: 'SkillHub',
  license: 'MIT',
  homepage: 'https://skillhub.com/skills/study-assistant-pro',
