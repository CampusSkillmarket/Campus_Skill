 ...
 * 
 * @package @skillhub/word-document-writer
 * @version 1.0.0
 * @author SkillHub
 * @license MIT
 * @see https://skillhub.com/skills/word-document-writer
 */

// Skill 配置
const skillConfig = {
  name: 'word-document-writer',
  displayName: '📝 Word 文档写作助手',
  version: '1.0.0',
  category: 'skillhub',
  format: 'skillhub-standard',
  author: 'SkillHub',
  license: 'MIT',
  homepage: 'https://skillhub.com/skills/word-document-writer',
