 ...
 * 
 * @package @skillhub/coursework-assistant
 * @version 1.0.0
 * @author SkillHub
 * @license MIT
 * @see https://skillhub.com/skills/coursework-assistant
 */

// Skill 配置
const skillConfig = {
  name: 'coursework-assistant',
  displayName: '📝 课程作业/项目完成助手',
  version: '1.0.0',
  category: 'skillhub',
  format: 'skillhub-standard',
  author: 'SkillHub',
  license: 'MIT',
  homepage: 'https://skillhub.com/skills/coursework-assistant',
