 ...
 * 
 * @package @skillhub/time-management
 * @version 1.0.0
 * @author SkillHub
 * @license MIT
 * @see https://skillhub.com/skills/time-management
 */

// Skill 配置
const skillConfig = {
  name: 'time-management',
  displayName: '⏰ 时间管理与效率提升助手',
  version: '1.0.0',
  category: 'skillhub',
  format: 'skillhub-standard',
  author: 'SkillHub',
  license: 'MIT',
  homepage: 'https://skillhub.com/skills/time-management',
