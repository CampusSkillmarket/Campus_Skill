...
1. 下载本仓库的 ZIP 文件
2. 解压后找到 `skills/final-exam-crash/SKILL.md`
3. 复制内容到 AI 助手配置
...
详见 [SKILL.md](https://github.com/CampusSkillmarket/skillhub-skills/blob/main/skills/final-exam-crash/SKILL.md) 中的使用示例部分。
