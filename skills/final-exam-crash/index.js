 ...
 * 
 * @package @skillhub/final-exam-crash
 * @version 1.0.0
 * @author SkillHub
 * @license MIT
 * @see https://skillhub.com/skills/final-exam-crash
 */

// Skill 配置
const skillConfig = {
  name: 'final-exam-crash',
  displayName: '📚 期末突击复习助手',
  version: '1.0.0',
  category: 'skillhub',
  format: 'skillhub-standard',
  author: 'SkillHub',
  license: 'MIT',
  homepage: 'https://skillhub.com/skills/final-exam-crash',
